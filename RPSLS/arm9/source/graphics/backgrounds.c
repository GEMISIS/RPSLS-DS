/*
 * The functions used to create and manage backgrounds.
 * Backgrounds are updated with the updateBackgrounds() function, which is called
 * automatically in the updateAll() method.
...
/*
 * Sets a set of tiles to a tile base.
 * @param screen The screen to create the background on.
 * @param index The index (layer) to create the background on.
